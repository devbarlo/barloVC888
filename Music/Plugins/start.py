        ...
        try:
            ...
            if member.id == BOT_ID:
                ...
                await message.reply_text(
                    f"""
👋 ** مرحبا عزيزي سأبذل قصاري جهدي لأسمعكم موسيقي عالية الجودة**

👮‍♂️ **لا تـنـسي ان تـقـوم ب تـعـيـنـي كـا مـشـرف **

👮‍♂️ **لا تـنـسي أعطاء البوت صلاحيه حذف الرسايل **
""",
...
👮‍♂️ لـمـعرفـة الـتـشـغـيـل والـتـحـكـم فـي الـبـوت وتـشـغـيـل الـمـوسـيـقـي تـابـع اسـفـل الـنـص 🎶**
